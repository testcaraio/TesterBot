...
lockskipPosition: 3,
lockskipReasons: [
["tema", "Essa musica esta no genero proibido, vou pular PORRA. "],
["op", "Para de repetir esse lixo seu arrombado, vou pular essa merda. "],
["history", "TA NO HISTORICO CARALHO, vou pular <3 "],
["mix", "You played a mix, which is against the rules. "],
["sound", "The song you played had bad sound quality or no sound. "],
["nsfw", "SE QUER BATER A GLORIOSA, USA A CALCINHA DA GORDA DA TUA MÃE PORRA, vou pular"],
["unavailable", "Essa porra tá bugaydowna, vou pular. "]
],
afkpositionCheck: 5,
afkRankCheck: "ambassador",
motdEnabled: false,
motdInterval: 5,
motd: "BEM VINDOS DELICIAS, leiam nossas regras kawaiizudas <3",
filterChat: true,
...
themeLink: null,
fbLink: "https://www.facebook.com/exercitopdj/",
youtubeLink: null,
website: null,
intervalMessages: [],
messageInterval: 5,
...
var pos = Math.floor((Math.random() * API.getWaitList().length) 50 + 1);
...
spam: [
'pula', 'pulaaaa', 'pulaa', 'pulaaa', 'pulaaaaa',
],
curses: [
'fuckthisroom',
]
...
rank: 'user',
type: 'startsWith',
cookies: ['jogou uma faca no seu piru',
'te puniu com um oco grosso no seu rabo',
'chamou a Dilma peladona para te matar',
'enfiou um pinto de borracha no seu cu, sem vaselina.',
'enfiou um ferro no seu piru',
'mandou você ir buscar a peça',
'te capturou com uma pokebola de rola',
...
rank: 'user',
type: 'startsWith',
cookies: ['te deu um biscoito de buceta',
'te deu um biscoito de piroka',
'te deu uma bolacha de goza',
'te deu o cu de sua mãe',
'te deu um biscoito de acabara de passar no rabo',
'te deu uma bolacha estragada',
'te deu um biscoito da África"',
],
getCookie: function () {
var c = Math.floor(Math.random() * this.cookies.length);
return this.cookies[c];
...
rank: 'user',
type: 'startsWith',
cookies: ['te bateu com a peça que o Jailson foi buscar',
'te bateu com o pinto do Kid Bengala',
'te bateu com um skate de modinha',
'te bateu na cama com uma piroka no seu cu.',
...
'quer 1 bilhão AHOE, pra não contar que voce é gay',
