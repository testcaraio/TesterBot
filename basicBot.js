    ...
    var basicBot = {
        ...
        commands: {
            ...
            biscoitoCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                biscoito: ['te deu um biscoito com ebola',
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.biscoito, {nameto: user.username, namefrom: chat.un, biscoito: this.getBiscoito()}));
                            }
                        }
                    }
                }
                ...
                rank: 'user',
                type: 'startsWith',
                sacanagem: ['enfiou o dedo no seu cu!',
                ...
                rank: 'user',
                type: 'startsWith',
                bater: ['te deu uma surra de pau mole',
                ...
                rank: 'user',
                type: 'startsWith',
                chantagear: ['disse que vai enfiar uma barra no cu se não contar',
